...
It launches 100 random experiments. We apply regularization. We use dual weights reparametrization.
...
all_args["weights_optim_mode"] = [BiseWeightsOptimEnum.NORMALIZED]
